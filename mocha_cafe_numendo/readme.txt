Quelques indications sur ma manière de procéder :

    Les images :
        J'ai procédé à :
            - une exportation des images au bon format et avec des dimensions proches de 1000 x 800 plûtot que d'avoir recours au clip-path
    ...
    La maquette : 
        J'ai privilégié :
            - l'utilisation de balises <nav>, <article>, <h1>, <h2>, <h6>
            - l'utilisation du CSS pour l'animation si possible
            - télécharger les polices et les importer depuis le CSS
    Dans le but de donner du sens à la page web et d'être mieux référencé.
    Gagner en performance et en fluidité pour les animations .
    Gagner en temps de chargement et optimiser le référencement.

    Les animations : 
        J'ai utilisé des animations : 
            - simples
            - rapides
            - suggestives
    Dans le but d'aider l'utilisateur et améliorer sa navigation sur le site web.
    Souligner les élements cliquables.
